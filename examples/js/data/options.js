export default {
  ...
  rows: [
    ...
    },
    {
      ...
      type: 'func',
      default: 'false',
      description: '<b>Функция кастомного переключения страниц</b><br />Принимает на вход выбранную страницу и размер страницы, должна вернуть промис, возвращающий объект содержащий: <b>rows</b><br />ОПЦИОНАЛЬНО: page - номер новой страницы, pageSize - размер страницы, sortBy - ключ по которому произведена сортировка, sortDir - направление сортировки "asc" "desc"',
    },
    {
      props: 'customSortChange',
      type: 'func',
      default: 'false',
      description: 'Кастомная сортировка, принимает на вход, свойство (ключ) колонки, номер текущей страницы, размер текущей страницы, должна вернуть промис, возвращающий объект: sortBy - ключ по которому сортировано, sortDir - направление сортировки "asc" "desc", rows - отсортированный массив строк. ОПЦИОНАЛЬНО: page - номер страницы, maxItems - если изменился (для кастомной пагинации), pageSize - если изменился',
    },
    {
      props: 'maxItems',
      type: 'number',
