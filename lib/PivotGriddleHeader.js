...
var PivotGriddleHeader = function (_Component) {
  ...
  _createClass(PivotGriddleHeader, [{
    ...
    key: 'getColSpan',
    value: function getColSpan(tree) {
      var _this2 = this;
      ...
      tree.children.forEach(function (leaf) {
        if (leaf.children) {
          var childLength = _this2.getColSpan(leaf, depth + 1);
    ...
    value: function columnParse(tree) {
      ...
      tree.forEach(function (node) {
        var currentColSpan = _this3.getColSpan(node);
        if (node.children) {
          sortable = false;
          childArr = _this3.columnParse(node.children, reassignDepth - 1, idx + 1, maxChild);
        ...
        if (!_this3.tableParse[idx]) {
          _this3.tableParse[idx] = [];
        }
        _this3.tableParse[idx].push(item);
      });
      return {
        rowSpan: rowSpan,
        depth: depth
    ...
    value: function renderCols(col) {
      ...
      if (col.sortable) {
        ...
        elRules.onClick = function () {
          return _this4.props.onSortChange(col.column);
        };
      }
      var key = 'th-' + (0, _objectHash2.default)(col) + '-' + (0, _objectHash2.default)(col.column);
