...
var PivotGriddleRow = function (_Component) {
  ...
  _createClass(PivotGriddleRow, [{
    ...
    value: function renderRow(row, columns, rowSpan) {
      ...
      return _react2.default.createElement(
        ...
        columns.map(function (col) {
          return _this3.preRenderCell(col, row, row, totalRow, rowSpan, child);
        })
      );
    }
  }, {
    ...
    value: function renderShowChild() {
      ...
      return _react2.default.createElement(
        'td',
        { className: 'systemCell', key: key, onClick: this.onChildShow },
        element
      ); //eslint-disable-line
    }
  }, {
    ...
    value: function renderDepthRow(row, columns) {
      ...
      if (this.state.showChild) {
        row[depthChildrenKey].forEach(function (child) {
          rows.push(_this4.renderRow(child, columns, false, false, true, '-' + (0, _objectHash2.default)(child)));
        });
      }
